...
map.getView().fit([-13188628.176134, 4031633.421696, -13144342.330350, 4057471.719799], map.getSize());
    ...
    element: (() => {
        ...
        if (306 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Data:<br />- Public parcels from County Assessor: https://egis-lacounty.hub.arcgis.com/datasets/lacounty::assessor-publicly-owned-parcels-current/about. Filtered to parcels owned by City of LA, including departments & CRA, excluding LAUSD.<br />- Surplus from GSD https://gsdlacity.wpengine.com/real-estate-services/';
            }
